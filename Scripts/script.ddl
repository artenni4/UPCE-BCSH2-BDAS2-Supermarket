...
CREATE OR REPLACE TRIGGER druhy_zbozi_druh_zbozi_id_trg BEFORE
    ...
    FOR EACH ROW
    WHEN ( new.druh_zbozi_id IS NULL )
BEGIN
...
CREATE OR REPLACE TRIGGER mista_ulozeni_misto_ulozeni_id BEFORE
    ...
    FOR EACH ROW
    WHEN ( new.misto_ulozeni_id IS NULL )
BEGIN
...
CREATE OR REPLACE TRIGGER pokladny_pokladna_id_trg BEFORE
    INSERT ON pokladny
    FOR EACH ROW
    WHEN ( new.pokladna_id IS NULL )
BEGIN
    :new.pokladna_id := pokladny_pokladna_id_seq.nextval;
END;
/

CREATE SEQUENCE prodane_zbozi_prodej_id_seq START WITH 1 NOCACHE ORDER;

CREATE OR REPLACE TRIGGER prodane_zbozi_prodej_id_trg BEFORE
    INSERT ON prodane_zbozi
    FOR EACH ROW
    WHEN ( new.prodej_id IS NULL )
BEGIN
    :new.prodej_id := prodane_zbozi_prodej_id_seq.nextval;
END;
/
...
CREATE OR REPLACE TRIGGER supermarkety_supermarket_id BEFORE
    ...
    FOR EACH ROW
    WHEN ( new.supermarket_id IS NULL )
BEGIN
